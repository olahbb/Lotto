...
//<editor-fold defaultstate="collapsed" desc="Class Variables">
    ...
    private final String WIN0 = "Sajnos nincs találatod!";
    private final String WIN1 = "Egyesed van a lottón!";
    private final String WIN2 = "Kettesed van a lottón!";
    private final String WIN3 = "Hármasod van a lottón!";
    private final String WIN4 = "Négyesed van a lottón!";
    private final String WIN5 = "Ötösöd van a lottón!";
...
//</editor-fold>
    ...
    private void handleButtonAction(ActionEvent event) 
        ...
        genNum1 = getRandandomNumber();
        genNum2 = getRandandomNumber();
        genNum3 = getRandandomNumber();
        genNum4 = getRandandomNumber();
        genNum5 = getRandandomNumber();
    ...
    private void calculate()
        ...
        //Számok 1-99 között vannak e
        for(Integer number : userNumbers)
            {
            if(number < MIN || number > MAX)
                {
                alert("Minden számnak 0 és 99 közöt kell lennie!");
                return; 
                }
            }
